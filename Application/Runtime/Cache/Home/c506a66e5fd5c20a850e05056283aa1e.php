            ...
            <div class="col-sm-2 col-lg-2">
                <div class="sidebar-nav">
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li><a href=""><span class="glyphicon glyphicon-check" aria-hidden="true"></span> 用户管理</a></li>
                        <li><a href=""><span class="glyphicon glyphicon-sort" aria-hidden="true"></span> 套餐管理</a></a></li>
                        <li><a href=""><span class="glyphicon glyphicon-pushpin" aria-hidden="true"></span> 节点管理</a></a></li>
                        <li><a href=""><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> 邀请管理</a></a></li>
                    </ul>
                </div>
            </div>
        </div>
