...
<body>
    <div class="top-nav">
        <nav class="navbar navbar-fixed-top">
            <div class="brand"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><a href="<?php echo U('Home/Index/index');?>" target="_self">AppSocks</a>- <span>您的加速科学上网助手</span></div>
            <div class="nav-list">
                <ul>
                    <li><a href="/appsocks/index.php/Home/Index/menu" target="_self">套餐订购</a></li>
                    <li><a href="/appsocks/index.php/Home/Help/download" target="_self">客户端下载</a></li>
